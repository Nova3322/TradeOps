...
> 后续状态：WP-0041 已将创建命令升级为 `execution.intent.create.v14` / payload schema 14；WP-0031..0035
...
> caller current leverage 并服务端派生，WP-0039/0040 再依次绑定正 UPNL 与 immutable Strategy Evaluation。
> 当前输入合同以 [WP-0041](WP-0041-INITIAL-Canonical空仓强绑定.md) 为准。
> 本文件保留 WP-0006 历史证据。
