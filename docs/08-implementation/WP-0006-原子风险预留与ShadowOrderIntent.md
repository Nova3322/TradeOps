...
> 后续状态：WP-0035 已将创建命令升级为 `execution.intent.create.v8` / payload schema 8；WP-0031..0035
> 先后移除 caller giveback、scope stress、classification、protection boolean 和九类 facts。
> 当前输入合同以 [WP-0035](WP-0035-不可变Risk-Fact-Set强绑定.md) 为准。本文件保留 WP-0006 历史证据。
