...
| 实现 | [WP-0056：Reduce-Only 计划当前有效性](08-implementation/WP-0056-Reduce-Only计划当前有效性.md) | stored plan 对 latest target、validity、fresh position/state/occupancy 重新求值；CURRENT 仍因执行条款 UNAVAILABLE 不可派发 |
