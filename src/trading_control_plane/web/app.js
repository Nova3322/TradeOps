...
function formatProposalRationale(value) {
  ...
  return `突破榜单当前同一精确合约、同一方向在 ${timeframes} 同时突破。${normalizedRiskCopy}提案已冻结，仍需人工审核；不会自动授权或下单。`;
}
