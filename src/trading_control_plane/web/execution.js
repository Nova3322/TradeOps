...
const DIRECT_CAPITAL_PATHS = [
  ...
  {path:'HYPERLIQUID_TO_VAULT', from:'Hyperliquid', to:'链上金库', badge:'仅 Arbitrum', action:'检查 Hyperliquid CCTP 回流条件', copy:'只允许提现到冻结的 Arbitrum 金库地址，固定扣除 0.2 USDC 协议费；旧 Legacy Bridge 路由会由服务端拒绝。', steps:['CCTP 提现','Arbitrum 确认','金库到账','回执验证']},
];
