...
const teamModeDialog = document.querySelector('#team-mode-dialog');
const teamModeDialogContent = document.querySelector('#team-mode-dialog-content');
...
let teamModeDialogRequestToken = 0;
