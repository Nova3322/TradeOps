...
async function renderHome() {
  ...
  if (approvedAwaitingLaunch.length) priorityCards.push(`<a class="home-priority attention" href="/reviews?view=current" data-link><span class="priority-number">${priorityCards.length + 1}</span><div><small>交易待启动</small><b>${approvedAwaitingLaunch.length} 笔已批准提案尚未形成交易任务</b><p>先重新运行实时风险检查，再签发短期授权；缺少事实或安全开关未满足时仍会阻断。</p></div><strong>查看当前提案 →</strong></a>`);
