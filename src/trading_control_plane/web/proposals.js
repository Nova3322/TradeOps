...
async function renderProposalList(status, title, historyMode = false) {
  ...
  const filter = ({resetLimit = false} = {}) => {
    ...
    document.querySelector('[data-proposal-count]').textContent = matched;
