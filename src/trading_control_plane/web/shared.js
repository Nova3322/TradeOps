...
const apiErrorGuidance = {
  ...
  POSITION_NOTIONAL_CURRENCY_UNSUPPORTED:'当前合约不是可按统一保证金币种换算的永续合约，请改选当前目录中的 USDT 或 USDC 永续合约。',
  POSITION_NOTIONAL_TOO_SMALL:'最大持仓金额低于该合约当前最小下单金额或数量步长，请提高最大持仓金额后重试。',
  INITIAL_POSITION_NOTIONAL_TOO_SMALL:'初仓金额低于该合约当前最小下单金额或数量步长，请提高初仓金额后重试。',
  INITIAL_POSITION_EXCEEDS_CAP:'初仓金额不能超过最大持仓金额，请降低初仓金额后重试。',
  INITIAL_POSITION_EXHAUSTS_CAP:'初仓已经占满最大持仓金额，没有为自动加仓保留空间；请降低初仓金额或关闭自动加仓。',
  INSTRUMENT_SPEC_INCOMPLETE:'当前合约缺少精度或最小下单量，系统已安全阻止创建提案；请等待合约目录刷新。',
  INSTRUMENT_PRECISION_INVALID:'当前合约精度无效，系统已安全阻止创建提案；请等待合约目录刷新。',
  INSTRUMENT_QUANTITY_ROUNDED_TO_ZERO:'最大持仓金额按当前数量步长换算后为零，请提高最大持仓金额。',
  INITIAL_QUANTITY_ROUNDED_TO_ZERO:'初仓金额按当前数量步长换算后为零，请提高初仓金额。',
  MINIMUM_NOTIONAL:'换算后的最大持仓金额低于交易所当前最小下单金额，请提高最大持仓金额。',
  INITIAL_MINIMUM_NOTIONAL:'换算后的初仓金额低于交易所当前最小下单金额，请提高初仓金额。',
  PROPOSAL_PRICE_INVALID:'触发价格、限价或失效价格不符合当前合约精度，请按合约价格步长调整后重试。',
  PROPOSAL_REFERENCE_PRICE_REQUIRED:'创建提案需要有效的触发价格，请填写大于零的触发价格。',
  PROPOSAL_RISK_INVALID:'触发价格与失效价格换算出的风险必须大于零，请调整失效价格。',
  PROPOSAL_RISK_EXCEEDED:'按当前持仓金额、触发价格和失效价格换算的实际风险超过最大风险；请降低持仓金额、收紧失效距离或提高最大风险。',
