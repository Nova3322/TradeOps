...
const ENGLISH_EXACT = new Map(Object.entries({
  ...
  '这里只展示仍在草稿或等待审核中的提案；批准后进入历史，后续交易生命周期由风险管理接手。':'Only drafts and pending reviews appear here. Approved proposals move to History and are handed to risk management.',
