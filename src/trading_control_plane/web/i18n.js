...
const ENGLISH_EXACT = new Map(Object.entries({
  ...
  '优先使用 Hyperliquid 当前官方 CCTP 路由，固定扣除 0.2 USDC 协议费；仅在官方路由明确回退时使用 Legacy Bridge。':'Use Hyperliquid’s current official CCTP route with a fixed 0.2 USDC protocol fee; use the Legacy Bridge only when the official route explicitly falls back.', '官方提现':'Official withdrawal', 'Arbitrum 确认':'Arbitrum confirmation', '金库到账':'Treasury credit',
