...
const ENGLISH_EXACT = new Map(Object.entries({
  ...
  'Safe 通过 Hyperliquid 官方 Bridge2 直接到账；NoTilt 先到授权自有地址再入库。withdraw3 当前固定扣除 1 USDC 协议提现费。':'Safe receives funds directly through the official Hyperliquid Bridge2; NoTilt first receives them at the authorized owned address. withdraw3 currently deducts a fixed 1 USDC protocol withdrawal fee.', '官方提现':'Official withdrawal', 'Arbitrum 确认':'Arbitrum confirmation', '金库到账':'Treasury credit',
